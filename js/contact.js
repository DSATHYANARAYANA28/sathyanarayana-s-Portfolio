...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Handle form submission — open WhatsApp chat with a prefilled message
  const WHATSAPP_NUMBER = "919080865593"; // country code + number, no '+' or spaces
  const handleFormSubmit = (e) => {
    ...
    const lines = [
      `Hi Sathya, I'd like to start a project.`,
      ``,
